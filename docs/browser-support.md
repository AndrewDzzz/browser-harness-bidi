...
|---|---|---|---|
| Firefox Desktop | First-class | `bidi-firefox`, `bidi-ruyi-firefox`, direct `BIDI_WS=ws://127.0.0.1:PORT/session`, or `geckodriver` with `webSocketUrl=true` | Recommended default and best-tested path |
